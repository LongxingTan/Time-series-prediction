...
class WaveNet(object):
    ...
    def __call__(self, inputs, teacher=None):
        if isinstance(inputs, (list, tuple)):
            ...
            encoder_feature = tf.concat([x, encoder_features], axis=-1)
...
class Decoder1(object):
    ...
    def __call__(self, decoder_features, decoder_init_input, encoder_outputs, teacher=None, scheduler_sampling=0,
