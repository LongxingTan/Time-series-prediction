...
class SpatialMaterializerTest(unittest.TestCase):
    def test_shared_graph_tensors_are_repeated_per_sample(self):
        ...
        self.assertEqual(inputs["structure.graph.adjacency"].shape, (2, 2, 2))
        self.assertEqual(inputs["structure.graph.node_mask"].shape, (2, 2))
        self.assertEqual(inputs["structure.graph.node_features"].shape, (2, 2, 3))
        self.assertEqual(inputs["structure.graph.node_coordinates"].shape, (2, 2, 2))
    ...
    def test_shared_grid_tensors_and_future_exclusion(self):
        ...
        self.assertEqual(inputs["structure.grid.valid_mask"].shape, (2, 2, 3))
        self.assertEqual(inputs["structure.grid.coordinates"].shape, (2, 2, 3, 2))
